...
const etre = [
  { label: 'Na e : Je suis', file: require('@/assets/sounds/douala/etre/na_e.wav') },
  { label: 'O e : Tu es', file: require('@/assets/sounds/douala/etre/o_e.wav') },
  { label: 'A e : Il/Elle est', file: require('@/assets/sounds/douala/etre/a_e.wav') },
  { label: 'DI e : Nous sommes', file: require('@/assets/sounds/douala/etre/di_e.wav') },
  { label: 'LO e : Vous êtes', file: require('@/assets/sounds/douala/etre/lo_e.wav') },
  { label: 'BA e : Ils/Elles sont', file: require('@/assets/sounds/douala/etre/ba_e.wav') },
];

export default function DoualaEtreLesson() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>🙋🏾‍♂️ Leçon 5 : Le verbe Être en Douala</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/douala/lesson6')}
        >
