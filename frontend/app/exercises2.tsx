...
import ThemeComponent from "@/components/exercises2";
...
export default function Ex3T0_2Page() {
  ...
  const renderTab = (label, iconName, route, isLogo = false, badge = null) => {
    const isActive = route === "/exercises2";
    ...
    <>
      ...
      >
        <View style={styles.tabs}>
          ...
          {renderTab("Exercices", "trophy-outline", "/exercises2", false, "bassa")}
