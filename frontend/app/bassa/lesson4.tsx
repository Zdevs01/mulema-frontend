...
const numbers = [
  { label: 'je suis : yè', file: require('@/assets/sounds/bassa/verbe3/1.wav') },
  { label: 'tu es : yè', file: require('@/assets/sounds/bassa/verbe3/2.wav') },
  { label: 'il ou elle est : yè', file: require('@/assets/sounds/bassa/verbe3/3.wav') },
  { label: 'nus sommes : yè', file: require('@/assets/sounds/bassa/verbe3/4.wav') },
  { label: 'vous etes : yè', file: require('@/assets/sounds/bassa/verbe3/5.wav') },
  { label: 'ils ou elles sont : yè', file: require('@/assets/sounds/bassa/verbe3/6.wav') },
];

export default function bassaNumberLesson() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>🔢 Leçon 4 : Le verbe etre en bassa</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/bassa/lesson5')}
        >
