...
const days = [
  { label: 'Lundi : ŋgwà njaŋgumba', file: require('@/assets/sounds/bassa/lundi.wav') },
  { label: 'Mardi : ŋgwà ûm', file: require('@/assets/sounds/bassa/mardi.wav') },
  { label: 'Mercredi : ŋgwà ŋgê', file: require('@/assets/sounds/bassa/mercredi.wav') },
  { label: 'Jeudi : ŋgwà mbɔk', file: require('@/assets/sounds/bassa/jeudi.wav') },
  { label: 'Vendredi : ŋgwà kɔɔ', file: require('@/assets/sounds/bassa/vendredi.wav') },
  { label: 'Samedi : ŋgwà jôn', file: require('@/assets/sounds/bassa/samedi.wav') },
  { label: 'Dimanche : ŋgwà nɔ̂y', file: require('@/assets/sounds/bassa/dimanche.wav') },
];

export default function bassaLesson1() {
  ...
  const handleNextLesson = async () => {
    try {
      ...
      if (response.ok) {
        ...
        router.push('/sage2'); // 👈 retour à Sage pour voir le changement
      } else {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>📚 Leçon 1 : Les jours de la semaine en bassa</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/bassa/lesson2')}
        >
