...
const etre = [
  { label: 'mɛ ̀ ɲjɛ ́  : je mange', file: require('@/assets/sounds/bassa/verbe4/1.wav') },
  { label: 'U ɲjɛ ́  : tu mange', file: require('@/assets/sounds/bassa/verbe4/2.wav') },
  { label: 'A ɲjɛ ́  : il ou elle mange', file: require('@/assets/sounds/bassa/verbe4/3.wav') },
  { label: 'Di ɲjɛ ́ : nous mangeons', file: require('@/assets/sounds/bassa/verbe4/4.wav') },
  { label: 'Ni ɲjɛ ́ : vous mangez', file: require('@/assets/sounds/bassa/verbe4/5.wav') },
  { label: 'Ba ɲjɛ ́  : ils ou elles magent', file: require('@/assets/sounds/bassa/verbe4/6.wav') },
];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>🙋🏾‍♂️ Leçon 5 : Le verbe Manger en bassa</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/bassa/lesson6')}
        >
