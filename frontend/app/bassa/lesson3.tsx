...
const colors = [
  ...
  { label: 'vous avez : gwě', file: require('@/assets/sounds/bassa/verbe2/5.wav') },
  { label: 'ils ont : gwě', file: require('@/assets/sounds/bassa/verbe2/6.wav') },
 
];

export default function bassaColorLesson() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}> Leçon 3 : Le verbe avoir en bassa</Text>
  ...
  <Animated.View style={[styles.confettiContainer, { opacity: successAnim }]}>
    ...
    <Text style={styles.confettiText}>🎉 Bravo !</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/bassa/lesson4')}
        >
