...
const pronouns = [
  ...
  { label: 'vous achetez : Ni Ńsɔ́mb ', file: require('@/assets/sounds/bassa/verbe1/5.wav') },
  { label: 'ils ou elles achetent : Ba Ńsɔ́mb ', file: require('@/assets/sounds/bassa/verbe1/6.wav') },
];

export default function bassaverbe1() {
...
<TouchableOpacity style={styles.backButton} onPress={() => router.push('/sage2')}>
  <Text style={styles.backButtonText}>⬅️ Retour</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>📖 Leçon 2 : Le verbe  acheter en bassa</Text>
  ...
  <Animated.View style={[styles.confettiContainer, { opacity: successAnim }]}>
    ...
    <Text style={styles.confettiText}>🎉 Bravo !</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/bassa/lesson3')}
        >
