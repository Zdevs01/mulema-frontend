...
const avoir = [
  { label: 'Gaə̂ giŋ : Je marche', file: require('@/assets/sounds/ghomala/verbe5/1.wav') },
  { label: 'ô giŋ: tu marche', file: require('@/assets/sounds/ghomala/verbe5/2.wav') },
  { label: 'ě giŋ  : il ou elle marche', file: require('@/assets/sounds/ghomala/verbe5/3.wav') },
  { label: 'pyə̂ giŋ : nous marchons', file: require('@/assets/sounds/ghomala/verbe5/4.wav') },
  { label: 'pô giŋ : vous marchez', file: require('@/assets/sounds/ghomala/verbe5/5.wav') },
  { label: 'wâp giŋ : ils ou elles marchent', file: require('@/assets/sounds/ghomala/verbe5/6.wav') },
];

export default function ghomalaAvoirLesson() {
    ...
    <View style={styles.centerContent}>
      ...
      >
        <Text style={styles.homeButtonText}>🏠 Retour à l’accueil</Text>
          ...
          <>
            <Text style={styles.title}>📚 Leçon finale : Le verbe marcher en ghomala</Text>
