...
const etre = [
  { label: 'Gaə̂ mpfaə : je mange', file: require('@/assets/sounds/ghomala/verbe4/1.wav') },
  { label: 'ô mpfaə : tu mange', file: require('@/assets/sounds/ghomala/verbe4/2.wav') },
  { label: 'ě mpfaə : il ou elle mange', file: require('@/assets/sounds/ghomala/verbe4/3.wav') },
  { label: 'pyə̂ mpfaə: nous mangeons', file: require('@/assets/sounds/ghomala/verbe4/4.wav') },
  { label: 'pô mpfaə : vous mangez', file: require('@/assets/sounds/ghomala/verbe4/5.wav') },
  { label: 'wâp mpfaə : ils ou elles magent', file: require('@/assets/sounds/ghomala/verbe4/6.wav') },
];

export default function ghomalaEtreLesson() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.title}>🙋🏾‍♂️ Leçon 5 : Le verbe Manger en ghomala</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/ghomala/lesson6')}
        >
