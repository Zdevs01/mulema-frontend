// ✅ ex1_t0_1.tsx (version finale immersive avec XP, Timer, Audio, Alertes)
...
const pairs = [
    { fr: "Le papa", douala: "tá (papá)", audio: require('@/assets/sounds/ghomala/th0/papa.wav'), order: 5 },
    { fr: "La maman", douala: "má (mamá)", audio: require('@/assets/sounds/ghomala/th0/maman.wav'), order: 3 },
    { fr: "La tante paternelle", douala: "fə̂ tâ á yə mjwǐ", audio: require('@/assets/sounds/ghomala/th0/tante_paternelle.wav'), order: 2 },
    { fr: "La tante maternelle", douala: "fə̂ mâ á yə mjwǐ", audio: require('@/assets/sounds/ghomala/th0/tante_maternelle.wav'), order: 1 },
    { fr: "L’oncle paternel", douala: "fə̂ tâ á yə mbɛ̂", audio: require('@/assets/sounds/ghomala/th0/oncle_paternel.wav'), order: 4 },
    { fr: "L’oncle maternel", douala: "fə̂ mâ á yə mbɛ̂", audio: require('@/assets/sounds/ghomala/th0/oncle_maternel.wav'), order: 7 },
    { fr: "Les grands-parents", douala: "mtâ pə̌ pyə gwyə́", audio: require('@/assets/sounds/ghomala/th0/grandparents.wav'), order: 6 },
    { fr: "Les amis", douala: "msǒ", audio: require('@/assets/sounds/ghomala/th0/amis.wav'), order: 9 },
    { fr: "Les enfants", douala: "pǒ", audio: require('@/assets/sounds/ghomala/th0/enfants.wav'), order: 8 },
    { fr: "Le bébé", douala: "mûbwǎ", audio: require('@/assets/sounds/ghomala/th0/bebe.wav'), order: 10 },
  ];

export default function Ex1_T0_1() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>🔗 Téma 0 - Associe les mots</Text>
