// ✅ ex3_t0_2.tsx (version finale immersive avec XP, Cauris, Timer et Audio)
...
const questions = [
  { label: "Bonjour mon ami.", correct: "Mɛ̀ ǹyega", audio: require('@/assets/sounds/bassa/th0/Bonjour mon ami.wav') },
  { label: "Comment vastu ?", correct: "ù ŋ́kɛ̀ laa", audio: require('@/assets/sounds/bassa/th0/Comment vastu.wav') },
  { label: "Je vais assez bien.", correct: "Mɛ̀ yè mboo", audio: require('@/assets/sounds/bassa/th0/Je vais assez bien.wav') },
  { label: "🙏 Merci.", correct: "mɛ̀ ǹyegà", audio: require('@/assets/sounds/bassa/th0/merci.wav') },
];

export default function Ex3_T0_2() {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {!success ? (
        <View style={styles.card}>
          <Text style={styles.title}>📝 theme 0 - Écris la bonne réponse</Text>
        ...
        <View style={styles.successBox}>
          ...
          <TouchableOpacity style={styles.submitBtn} onPress={() => router.push('/ex3_t0_3')}>
