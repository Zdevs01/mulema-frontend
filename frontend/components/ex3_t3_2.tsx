// ✅ Ex3_T3_2 - écrire en ghomala (Téma 3) avec XP, cauris, timer, animation et progression = 12
...
const questions = [
  { label: "👔 La cravate", correct: "Lilàŋ lini", audio: require('@/assets/sounds/bassa/th3/cravate.wav') },
  { label: "Cet habit", correct: "Mbɔt", audio: require('@/assets/sounds/bassa/th3/habit.wav') },
  { label: "Une chemise", correct: "Sɔdɛ̂", audio: require('@/assets/sounds/bassa/th3/chemise.wav') },
  { label: "Une veste", correct: "Kodî", audio: require('@/assets/sounds/bassa/th3/veste.wav') },
 
];

export default function Ex3_T3_2() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>📝 theme 3 - Écris la bonne réponse</Text>
      ...
      {!showSuccess ? (
        ...
        <View style={styles.successContainer}>
          ...
          <TouchableOpacity style={styles.submitBtn} onPress={() => router.push('/ex3_t3_3')}>
