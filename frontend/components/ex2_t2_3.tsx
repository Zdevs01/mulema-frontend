// ✅ Ex2_T2_3.tsx – Sélection d’image immersive avec XP, Timer et Cauris (Téma 2 - Exercice 3)
...
const data = [
  {
    label: "Le feu",
    correctIndex: 0,
    audio: require('@/assets/sounds/ghomala/th2/feu.wav'),
    images: [
      require('@/assets/images/th2/feu.jpg'),
      require('@/assets/images/th2/farine.jpg'),
      require('@/assets/images/th2/pilon_mortier.jpg'),
  ...
  },
  {
    label: "La farine",
    correctIndex: 3,
    audio: require('@/assets/sounds/ghomala/th2/farine.wav'),
    images: [
      require('@/assets/images/th2/huile.jpg'),
      require('@/assets/images/th2/pilon_mortier.jpg'),
      require('@/assets/images/th2/feu.jpg'),
  ...
  },
  {
    label: "🪔 L’huile",
    correctIndex: 1,
    audio: require('@/assets/sounds/ghomala/th2/huile.wav'),
    images: [
      require('@/assets/images/th2/feu.jpg'),
      require('@/assets/images/th2/huile.jpg'),
      require('@/assets/images/th2/farine.jpg'),
  ...
  {
    label: "le pilon_mortier",
    correctIndex: 0,
    audio: require('@/assets/sounds/ghomala/th2/pilon_mortier.wav'),
    images: [
      require('@/assets/images/th2/feu.jpg'),
      require('@/assets/images/th2/farine.jpg'),
      require('@/assets/images/th2/huile.jpg'),
...
export default function Ex2_T2_3() {
