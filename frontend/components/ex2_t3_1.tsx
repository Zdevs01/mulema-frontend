...
const pairs = [
  { fr: "Cet habit", douala: "dzə́ yə̌ŋ", audio: require('@/assets/sounds/ghomala/th3/habit.wav') },
  { fr: "Cette chemise", douala: "təŋka’dzə́ yə̌ŋ", audio: require('@/assets/sounds/ghomala/th3/chemise.wav') },
  { fr: "Ce pantalon", douala: "tɛ́sho’ yə̌ŋ", audio: require('@/assets/sounds/ghomala/th3/pantalon.wav') },
  { fr: "Ces caleçons", douala: "mdzə̂cu mɔ̌", audio: require('@/assets/sounds/ghomala/th3/calecon.wav') },
  { fr: "Ces costumes", douala: "mcwopdəm mɔ̌", audio: require('@/assets/sounds/ghomala/th3/costume.wav') },
  { fr: "Cette culotte", douala: "kamtɛ́sho’ yə̌ŋ", audio: require('@/assets/sounds/ghomala/th3/culotte.wav') },
  { fr: "Ces boubous", douala: "msʉɔdzə́ mɔ̌", audio: require('@/assets/sounds/ghomala/th3/boubou.wav') },
  { fr: "Cette chaussure", douala: "Mtǎp mɔ̌", audio: require('@/assets/sounds/ghomala/th3/chaussure.wav') },
  { fr: "Ce chapeau", douala: "co’ yə̌ŋ", audio: require('@/assets/sounds/ghomala/th3/chapeau.wav') },
];

export default function Ex2_T3_1() {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Modal animationType="slide" transparent={true} visible={showZeroCauri}>
        <View style={styles.modalOverlay}>
          ...
          <TouchableOpacity style={styles.homeButton} onPress={() => router.replace('/home3')}>
