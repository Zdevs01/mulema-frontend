// ✅ Ex1_T2_3.tsx – Sélection d’image immersive avec XP, Timer et Cauris (Téma 2 - Exercice 3)
...
const data = [
  {
    label: "🍴 La fourchette",
    correctIndex: 0,
    audio: require('@/assets/sounds/douala/th2/fourchette.wav'),
    images: [
  ...
  },
  {
    ...
    correctIndex: 3,
    audio: require('@/assets/sounds/douala/th2/feu_bois.wav'),
    images: [
      require('@/assets/images/th2/huile.jpg'),
      require('@/assets/images/th2/pilon_mortier.jpg'),
      require('@/assets/images/th2/fourchette.jpg'),
  ...
  },
  {
    label: "🪔 L’huile",
    correctIndex: 1,
    audio: require('@/assets/sounds/douala/th2/huile.wav'),
    images: [
      require('@/assets/images/th2/feu.jpg'),
      require('@/assets/images/th2/huile.jpg'),
      require('@/assets/images/th2/fourchette.jpg'),
  ...
  },
  {
    label: "🔥 Le feu",
    correctIndex: 0,
    audio: require('@/assets/sounds/douala/th2/feu.wav'),
    images: [
      require('@/assets/images/th2/feu.jpg'),
      require('@/assets/images/th2/fourchette.jpg'),
      require('@/assets/images/th2/huile.jpg'),
...
export default function Ex1_T2_3() {
