// ✅ ex2_t1_1.tsx (version finale immersive avec XP, Timer, Audio, Alertes)
...
const pairs = [
    { fr: "Le lion", douala: "nɔmtə̀mà’", audio: require('@/assets/sounds/ghomala/th1/lion.wav'), order: 5 },
    { fr: "Le poisson", douala: "gù (bapgù)", audio: require('@/assets/sounds/ghomala/th1/poisson.wav'), order: 3 },
    { fr: "L’huile", douala: "mwaə̌", audio: require('@/assets/sounds/ghomala/th1/huile.wav'), order: 2 },
    { fr: "Le bœuf", douala: "na’", audio: require('@/assets/sounds/ghomala/th1/bœuf.wav'), order: 1 },
    { fr: "Le poulet", douala: "gɔ̌p", audio: require('@/assets/sounds/ghomala/th1/poulet.wav'), order: 4 },
  ];

export default function Ex2_T1_1() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={[styles.continueBtn, matched.length === pairs.length ? styles.continueActive : styles.continueDisabled]} onPress={() => router.push('/ex2_t1_2')} disabled={matched.length !== pairs.length}>
