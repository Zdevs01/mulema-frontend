// ✅ ex1_t1_3.tsx (version complète avec correction Haptics Web + Timer OK)
...
const imageMap = {
  ...
  'singe.jpg': require('@/assets/images/th1/singe.jpg'),
  'poisson.jpg': require('@/assets/images/th1/poisson.jpg'),
  'lion.jpg': require('@/assets/images/th1/lion.jpg'),
};

const rawData = [
  { label: "🐝 Les abeilles", correct: 'abeilles.png', audio: require('@/assets/sounds/douala/th1/abeilles.wav'), images: ['abeilles.png', 'sauterelle.png', 'cafard.webp', 'singe.jpg'] },
  { label: "🦗 La sauterelle", correct: 'sauterelle.png', audio: require('@/assets/sounds/douala/th1/sauterelle.wav'), images: ['sauterelle.png', 'lion.jpg', 'cafard.webp', 'singe.jpg'] },
  { label: "🪳 Le cafard", correct: 'cafard.webp', audio: require('@/assets/sounds/douala/th1/cafard.wav'), images: ['singe.jpg', 'cafard.webp', 'abeilles.png', 'poisson.jpg'] },
  { label: "Poissons", correct: 'poisson.jpg', audio: require('@/assets/sounds/douala/th1/poisson.wav'), images: ['singe.jpg', 'poisson.jpg', 'abeilles.png', 'sauterelle.png'] },
  { label: "Le Lion", correct: 'lion.jpg', audio: require('@/assets/sounds/douala/th1/lion.wav'), images: ['singe.jpg', 'lion.jpg', 'cafard.webp', 'abeilles.png'] },
  { label: "🐒 Les singes", correct: 'singe.jpg', audio: require('@/assets/sounds/douala/th1/singes.wav'), images: ['abeilles.png', 'sauterelle.png', 'cafard.webp', 'singe.jpg'] }
];
...
export default function ex1_t1_3() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.centeredContainer}>
      <NavTime />
      <Text style={styles.title}>🖼️ Téma 1 - Choisis la bonne image</Text>
      ...
      {showSuccess && (
        <Animated.View style={[styles.overlay, { opacity: anim }]}> 
          ...
          <TouchableOpacity style={styles.nextBtn} onPress={() => router.push('/ex1_t1_3')}>
