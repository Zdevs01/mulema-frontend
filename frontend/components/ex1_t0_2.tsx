// ✅ ex1_t0_2.tsx (version finale immersive avec XP, Cauris, Timer et Audio)
...
const questions = [
  { label: "👫 Les amis", correct: "Makɔ́m", audio: require('@/assets/sounds/douala/th0/amis.wav') },
  { label: "👵👴 Les grands-parents", correct: "Ɓambámbɛ́", audio: require('@/assets/sounds/douala/th0/grandparents.wav') },
  { label: "🙏 Merci.", correct: "Na sôm.", audio: require('@/assets/sounds/douala/th0/merci.wav') },
];

export default function Ex1_T0_2() {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {!success ? (
        ...
        <View style={styles.successBox}>
          ...
          <TouchableOpacity style={styles.submitBtn} onPress={() => router.push('/ex1_t0_3')}>
