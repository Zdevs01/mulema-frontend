...
// ✅ ex3_t3_3.tsx complet avec XP, cauris, progression (advance=13), time12
...
const imageMap = {
  'veste.webp': require('@/assets/images/th3/veste.webp'),
  ...
  'habit.jpg': require('@/assets/images/th3/habit.jpg'),
};
...
const rawData = [
  {
    label: "🧥 La veste",
    correct: 'veste.webp',
    audio: require('@/assets/sounds/bassa/th3/veste.wav'),
    images: ['veste.webp', 'pantalon.jpg', 'cravate.webp', 'chaussure.webp']
  },
  {
    label: "👖 Les pantalons",
    correct: 'pantalon.jpg',
    audio: require('@/assets/sounds/bassa/th3/pantalon.wav'),
    images: ['pantalon.jpg', 'habit.jpg', 'chaussure.webp', 'cravate.webp']
  },
  {
    label: "La cravate",
    correct: 'cravate.webp',
    audio: require('@/assets/sounds/bassa/th3/cravate.wav'),
    images: ['chaussure.webp', 'cravate.webp', 'veste.webp', 'habit.jpg']
  },
  {
    label: "👞 La chaussure",
    correct: 'chaussure.webp',
    audio: require('@/assets/sounds/bassa/th3/chaussure.wav'),
    images: ['cravate.webp', 'habit.jpg', 'chaussure.webp', 'veste.webp']
  },
  {
    label: "habit",
    correct: 'habit.jpg',
    audio: require('@/assets/sounds/bassa/th3/habit.wav'),
    images: ['pantalon.jpg', 'habit.jpg', 'chaussure.webp', 'veste.webp']
  }
];
...
export default function ex3_t3_3() {
