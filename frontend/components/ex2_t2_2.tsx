// ✅ Ex2_T2_2.tsx - Écriture Téma 2 avec XP, Cauris, Temps, Oups et Progression (time7)
...
const questions = [
  { label: "Le feu", correct: "mɔ̌k", audio: require('@/assets/sounds/ghomala/th2/feu.wav') },
  { label: "L’eau", correct: "shyə", audio: require('@/assets/sounds/ghomala/th2/eau.wav') },
  { label: "La farine", correct: "və́msɛ̂ntʉɔ̀", audio: require('@/assets/sounds/ghomala/th2/farine.wav') },
  { label: "La flamme", correct: "zhwyə̌mɔ́k", audio: require('@/assets/sounds/ghomala/th2/flamme.wav') }
];

export default function Ex2_T2_2() {
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text>.</Text>
        <Text>.</Text>
        <Text style={styles.title}>✍️ Téma 2 - Écrire en ghomala</Text>
        ...
        {!showSuccess ? (
          ...
          <View style={styles.successContainer}>
            ...
            <TouchableOpacity style={styles.nextBtn} onPress={() => router.push('/ex2_t2_3')}>
