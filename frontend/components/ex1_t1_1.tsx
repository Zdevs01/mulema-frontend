// ✅ Ex1_T1_1.tsx (version finale immersive avec XP, Timer, Audio, Alertes - time4)
...
const pairs = [
  { fr: "Ŋgila", douala: "Le lion", audio: require('@/assets/sounds/douala/th1/lion.wav') },
  { fr: "La girafe", douala: "Ŋgilóɓa", audio: require('@/assets/sounds/douala/th1/girafe.wav') },
  { fr: "Le bœuf", douala: "Nyaka", audio: require('@/assets/sounds/douala/th1/boeuf.wav') },
  { fr: "Le poisson", douala: "Súe", audio: require('@/assets/sounds/douala/th1/poisson.wav') },
  { fr: "Le poulet", douala: "ǹyògól", audio: require('@/assets/sounds/douala/th1/poulet.wav') },
  { fr: "Les abeilles", douala: "Ndɔ́mbí", audio: require('@/assets/sounds/douala/th1/abeilles.wav') },
  { fr: "Le cafard", douala: "Epɛ́pɛ́njú/ kákróti", audio: require('@/assets/sounds/douala/th1/cafard.wav') },
  { fr: "Les singes", douala: "Kéma", audio: require('@/assets/sounds/douala/th1/singes.wav') },
  { fr: "La sauterelle", douala: "dikélé", audio: require('@/assets/sounds/douala/th1/sauterelle.wav') },
];
	 
export default function Ex1_T1_1() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>🔗 Téma 1 - Associe les mots</Text>
