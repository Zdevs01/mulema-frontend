// ✅ ex2_t2_1.tsx – Associer les animaux (Téma 2 - Exercice 1 avec timer, XP, cauris, alertes et animation)
...
const pairs = [
  { fr: "Le feu", douala: "mɔ̌k", audio: require('@/assets/sounds/ghomala/th2/feu.wav') },
  { fr: "La flamme", douala: "zhwyə̌mɔ́k", audio: require('@/assets/sounds/ghomala/th2/flamme.wav') },
  { fr: "L’eau", douala: "shyə", audio: require('@/assets/sounds/ghomala/th2/eau.wav') },
  { fr: "Le sel", douala: "gwɛ̌", audio: require('@/assets/sounds/ghomala/th2/sel.wav') },
  { fr: "L’huile", douala: "mwaə̌", audio: require('@/assets/sounds/ghomala/th2/huile.wav') },
  { fr: "Le sucre", douala: "tʉ̀mtə̀", audio: require('@/assets/sounds/ghomala/th2/sucre.wav') },
  { fr: "La farine", douala: "və́msɛ̂ntʉɔ̀", audio: require('@/assets/sounds/ghomala/th2/farine.wav') },
];

export default function Ex2_T2_1() {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Modal animationType="slide" transparent={true} visible={showZeroCauri}>
        <View style={styles.modalOverlay}>
          ...
          <TouchableOpacity style={styles.homeButton} onPress={() => { setShowZeroCauri(false); router.replace('/home3'); }}>
