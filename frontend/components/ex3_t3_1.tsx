...
const pairs = [
  { fr: "Cet habit", douala: "i mbɔ̄t ìni", audio: require('@/assets/sounds/bassa/th3/habit.wav') },
  { fr: "Cette chemise", douala: "i jɔ̄mbɛ lini", audio: require('@/assets/sounds/bassa/th3/chemise.wav') },
  { fr: "Ce pantalon", douala: "i tɔ̀lɔ̀sîs nunu", audio: require('@/assets/sounds/bassa/th3/pantalon.wav') },
  { fr: "Ces caleçons", douala: "i ŋkāndā unu", audio: require('@/assets/sounds/bassa/th3/calecon.wav') },
  { fr: "Ce manteau", douala: "i kodi mbèŋ ìni", audio: require('@/assets/sounds/bassa/th3/manteau.wav') },
  { fr: "Ces costumes", douala: "bikōdī bini", audio: require('@/assets/sounds/bassa/th3/costume.wav') },
  { fr: "Ces boubous", douala: "ɓa ɓùba ɓana", audio: require('@/assets/sounds/bassa/th3/boubou.wav') },
  { fr: "Cette chaussure", douala: "i tāmb ini", audio: require('@/assets/sounds/bassa/th3/chaussure.wav') },
  { fr: "Ce chapeau", douala: "i tàmba nunu", audio: require('@/assets/sounds/bassa/th3/chapeau.wav') },
];

export default function Ex3_T3_1() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.title}>🧥 theme 3 - Associe les habits</Text>
      ...
      <Modal animationType="slide" transparent={true} visible={showZeroCauri}>
        <View style={styles.modalOverlay}>
          ...
          <TouchableOpacity style={styles.homeButton} onPress={() => router.replace('/home4')}>
