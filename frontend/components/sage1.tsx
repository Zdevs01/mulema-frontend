...
export default function Sage1() {
  ...
  const lessons = [
    { title: 'Les 7 jours de la semaine', route: '/ghomala/lesson_play', unlocked: true },
    { title: 'Conjugaison du verbe avoir au présent', route: '/ghomala/lesson2', unlocked: true },
    { title: 'Être au présent', route: '/ghomala/lesson3', unlocked: progress >= 4 },
    { title: 'Chiffres de 1 à 9', route: '/ghomala/lesson4', unlocked: progress >= 4 },
    { title: 'Les couleurs', route: '/ghomala/lesson5', unlocked: progress >= 7 },
    { title: 'Pronoms personnels', route: '/ghomala/lesson6', unlocked: progress >= 7 },
  ];
