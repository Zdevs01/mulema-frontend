...
export default function Exercices1() {
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.startButton} onPress={() => router.push('/home3')}>
          <Text style={styles.startText}>Commencer les exercices ➜</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.alphabetButton} onPress={() => router.push('/alphaghomala')}>
          <Text style={styles.alphabetText}>🔤 Voir l’alphabet ghomala</Text>
        </TouchableOpacity>
      </ScrollView>
    </>
  );
