// ✅ Ex1_T3_2 - écrire en Douala (Téma 3) avec XP, cauris, timer, animation et progression = 12
...
const questions = [
  { label: "👔 La cravate", correct: "Kɔ́la", audio: require('@/assets/sounds/douala/th3/cravate.wav') },
  { label: "🎩 Ce chapeau", correct: "Yé ekótó", audio: require('@/assets/sounds/douala/th3/chapeau.wav') },
  { label: "🧥 Ce manteau", correct: "Dí lóki", audio: require('@/assets/sounds/douala/th3/manteau.wav') },
  { label: "👟 La chaussure", correct: "Etámbí", audio: require('@/assets/sounds/douala/th3/chaussure.wav') },
  { label: "💼 Le travail", correct: "Eɓoló", audio: require('@/assets/sounds/douala/th3/travail.wav') },
];

export default function Ex1_T3_2() {
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {!showSuccess ? (
        ...
        <View style={styles.successContainer}>
          ...
          <TouchableOpacity style={styles.submitBtn} onPress={() => router.push('/ex1_t3_3')}>
