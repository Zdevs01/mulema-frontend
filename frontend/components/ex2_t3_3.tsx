...
// ✅ ex2_t3_3.tsx complet avec XP, cauris, progression (advance=13), time12
...
const imageMap = {
  ...
  'cravate.webp': require('@/assets/images/th3/cravate.webp'),
...
const rawData = [
  {
    label: "🧥 La veste",
    correct: 'koti.webp',
    audio: require('@/assets/sounds/ghomala/th3/veste.wav'),
    images: ['koti.webp', 'pantalon.jpg', 'cravate.webp', 'chaussure.webp']
  },
  {
    label: "👖 Les pantalons",
    correct: 'pantalon.jpg',
    audio: require('@/assets/sounds/ghomala/th3/pantalon.wav'),
    images: ['pantalon.jpg', 'babouche.webp', 'chaussure.webp', 'cravate.webp']
  },
  {
    label: "La cravate",
    correct: 'cravate.webp',
    audio: require('@/assets/sounds/ghomala/th3/cravate.wav'),
    images: ['chaussure.webp', 'cravate.webp', 'koti.webp', 'babouche.webp']
  },
  {
    label: "👞 La chaussure",
    correct: 'chaussure.webp',
    audio: require('@/assets/sounds/ghomala/th3/chaussure.wav'),
    images: ['cravate.webp', 'babouche.webp', 'chaussure.webp', 'koti.webp']
  },
  {
    label: "🩴 Les paires de babouches",
    correct: 'babouche.webp',
    audio: require('@/assets/sounds/ghomala/th3/babouche.wav'),
...
export default function ex2_t3_3() {
    ...
    <>
      ...
      <Modal animationType="slide" transparent={true} visible={showZeroCauri}>
        <View style={styles.successOverlay}>
          ...
          <TouchableOpacity style={styles.nextBtn} onPress={() => router.replace('/home3')}>
      ...
      {showFinal ? (
        <View style={styles.successOverlay}>
          ...
          <TouchableOpacity style={styles.nextBtn} onPress={() => router.push('/home3')}>
            <Text style={styles.nextBtnText}>🏡 Retour à l'accueil</Text>
          </TouchableOpacity>
        </View>
      ) : (
